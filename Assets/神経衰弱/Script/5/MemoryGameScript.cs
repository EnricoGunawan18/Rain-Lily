...
public class MemoryGameScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        finishScreen = GameObject.Find("GameFinish");
        finishScreen.GetComponent<FinishScript>().enabled = false;
        ...
        outline8 = GameObject.Find("Ingredients8").GetComponent<Outline>();
        outline9 = GameObject.Find("Ingredients9").GetComponent<Outline>();
        outline10 = GameObject.Find("Ingredients10").GetComponent<Outline>();

        //Command Text
        randText = Random.Range(1, 10);
        randText2 = Random.Range(1, 10);
        randText3 = Random.Range(1, 10);
        while (randText2 == randText)
        {
            randText2 = Random.Range(1, 10);
        }
        while (randText3 == randText2 || randText3 == randText)
        {
            randText3 = Random.Range(1, 10);
        }
        ...
        command_Text.text = "「今日は" + Text1 + Text2 + Text3 + "を買おう」";
    ...
    void Update()
    {
        ...
        if (timer >= 2.5)
        {
            ...
            if (count2 > 5)
            {
                ...
                //text
                command_Text.text = "「買うものが「三つ」あったよね」";
            }
            ...
            if (nowStage == 4 || nowStage == 5)
            {
                if (correctAns == 3)
                {
                    ...
                    //PlayerPrefs.SetFloat("Score5", scoreNow);

                    Debug.Log(scoreNow);

                    finishScreen = GameObject.Find("GameFinish");
                    finishScreen.GetComponent<FinishScript>().enabled = true;
