...
public class LoadDialogue : MonoBehaviour
{
	...
	private void Start()
	{
		...
		if (menu == 0 || menu == 6 || menu == 7 || menu == 8 || menu == 11 || menu == 14 || menu == 15)
		{
