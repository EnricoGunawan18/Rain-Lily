...
public class still6Script : MonoBehaviour
{
	[SerializeField]
	Button Play;
	...
	void PlayButton()
	{
		...
		PlayerPrefs.SetInt("ResetPos", 118);//////////////////change each script pls(Enrico reminder)
		PlayerPrefs.SetInt("NovelMenu", 17);//////////////////change each script pls(Enrico reminder)

		int[] startDate = { 11, 8 };//////////////////change each script pls(Enrico reminder)
		PlayerPrefsX.SetIntArray("Date", startDate);

		PlayerPrefs.SetInt("Money", 0);
		PlayerPrefs.SetFloat("LiedHeart", 25);//////////////////change each script pls(Enrico reminder)
