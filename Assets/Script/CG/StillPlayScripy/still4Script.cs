...
public class still4Script : MonoBehaviour
{
	[SerializeField]
	Button Play;
	...
	void PlayButton()
	{
		...
		PlayerPrefs.SetInt("ResetPos", 114);//////////////////change each script pls(Enrico reminder)
		PlayerPrefs.SetInt("NovelMenu", 37);//////////////////change each script pls(Enrico reminder)
		...
		PlayerPrefs.SetFloat("KleinHeart", 60);//////////////////change each script pls(Enrico reminder)
